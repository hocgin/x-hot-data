...
| 平台 | Provider ID | API/URL | 备注 | 优先级 |
|------|-------------|---------|------|--------|
| IT之家 | ithome-hot | https://m.ithome.com/rankm/ | HTML 解析 | 990 |
| 少数派 | sspai-hot | https://sspai.com/api/v1/article/tag/page/get | JSON API | 989 |
| AcFun | acfun-hot | https://www.acfun.cn/rest/pc-direct/rank/channel | JSON API | 988 |
| 安全客 | anquanke-hot | https://www.anquanke.com/webapi/api/index/top/list | JSON API | 987 |
| 36氪 | kr36-hot | https://36kr.com/hot-list/renqi/{date}/1 | HTML 解析 | 986 |
| 虎扑 | hupu-hot | https://www.hupu.com/ | HTML 解析 | 985 |
| 豆瓣小组 | douban-group-hot | https://www.douban.com/group/explore | HTML 解析 | 984 |
| 吾爱破解 | wuaipojie-hot | https://www.52pojie.cn/misc.php?mod=ranklist | HTML 解析 | 983 |
| 搜狗 | sougou-hot | - | - | 982 |
| 360搜索 | 360search-hot | - | - | 981 |
| 贴吧 | tieba-hot | - | - | 980 |
| 腾讯新闻 | qqnews-hot | - | - | 979 |
| 什么值得买 | smzdm-hot | - | - | 978 |
| 易车网 | yiche-hot | - | - | 977 |
| 游戏葡萄 | youxiputao-hot | - | - | 976 |
| 懂球帝 | dongqiudi-hot | - | - | 975 |

## 平台对接规范

### 1. 配置文件 (src/config/platforms.ts)
